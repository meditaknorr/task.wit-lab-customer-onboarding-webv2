 ...
 * @param description  { a String that defines the description of the photo that is ging to be displayed }
 ...
 * @param storeProperty {a String containing the key value of the property that needs to be sent to the store}
 * @param screenLabel {String with the header label for the screen}
 * @param progressBar {a Number with the percent of the progress bar divided by 10 (must be from 0 - 10)}
 ...
 * @constructor
 */
const ConfirmPhoto = ({ description, photo, usePhoto, takeAnotherPhoto, storeProperty, screenLabel, progressBar, overlayMode }) => {
