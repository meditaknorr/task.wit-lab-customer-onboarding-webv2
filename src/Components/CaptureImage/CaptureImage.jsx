 ...
 * @param overlayMode {a Number containing key that indicates either the frame is rounded or squared
 * - 1 for rounded and 0 for squared}
 ...
 * @param storeProperty {an Object used to define whats the name of the store
 * property that is going to hold the photo object}
 * @returns {JSX.Element}
 * @constructor
 */
const CaptureImage = ({
        ...
        <div className="video-background-wrapper">
          <div className="video-container">
            <div className="camera" ref={overlayRef}>
              ...
              <button onClick={takePhoto} className="camera__shoot-button" />
